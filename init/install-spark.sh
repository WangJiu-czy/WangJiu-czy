...
wget -q -P $SP_HOME/conf  $F1 -O $SP_HOME/conf/spark-defaults.conf
wget -q -P $SP_HOME/conf  $F2 -O $SP_HOME/conf/spark-env.sh
wget -q -P $SP_HOME/conf  $F3 -O $SP_HOME/conf/workers
