...
wget -P /opt/install/spark/conf  $F1 -O /opt/install/hbase/conf/spark-defaults.conf
wget -P /opt/install/spark/conf  $F2 -O /opt/install/hbase/conf/spark-env.sh
wget -P /opt/install/spark/conf  $F3 -O /opt/install/hbase/conf/workers
