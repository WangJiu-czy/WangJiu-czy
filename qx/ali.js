  ...
  if (typeof $request !== "undefined") {
    if ($request.url.indexOf('/mock/read') > 0) {
     ...
     <html>
      ...
      <body bgcolor="#FFFFFF"><p p style="text-align: center;font-size:7vw;">薅羊毛，冲冲冲！</p><p style="text-align:right;font-size:7vw;">——WangJiu</p><div id="timer"></div></body>
      <script>
...
//这个url是微信提供是一个测试接口，是空白页面，并不会产生阅读数据
    ...
    //添加云扫码//yunonline/v1
  if (url.indexOf('work/fast_reada/oiejr') > 0 ||url.indexOf('/yunonline/v1/jump') > 0 ){
      const headers = {
          "Connection": "keep-alive",
          'Content-Type': 'text/html; charset=utf-8',
          'Location':newUrl,
